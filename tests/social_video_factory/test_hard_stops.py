...
_CANNED = {
    ...
    "consent_policy_modal": "Before you continue, we use cookies",
}
...
def test_priority_order_login_before_consent():
    ...
    text = "Please sign in. Before you continue, we use cookies."
    assert detect_hard_stop(text, {}) == "login"


def test_case_insensitive():
    assert detect_hard_stop("PLEASE SIGN IN", {}) == "login"
